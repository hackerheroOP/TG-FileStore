        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("Channel", url="https://t.me/bhabhi_ke_pom_pom"),
                        InlineKeyboardButton("Movies Channel", url="https://t.me/movies_unloaded2")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/Movies_Request02)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=pro_morningstar_{str_to_b64(file_er_id)}"
                ...
                [
                    [
                        InlineKeyboardButton("Movies Channel",
                                             url="https://t.me/Movies_Unloaded2")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my.",
                        disable_web_page_preview=True
                    )
                    return
